...
Ku.AutoExpand = Class({
	...
	setGripRightSpacing : function(){
		this.gripRightSpacing=this.options.gripImg_x_spacing;
	...
	draw:function(){
		var iBottom = $Agent().Gecko ? -1 : 0 ;
		var iRight = $Agent().Gecko ? 0 : 0 ;
		
	    this.imgGrip.style.bottom = iBottom + "px";
	    this.imgGrip.style.right = iRight + "px";
	}
});
/**
